...
public class SlidingActivityHelper {
	...
	/**
	 * Finds a myview that was identified by the id attribute from the XML that was processed in onCreate(Bundle).
	 * 
	 * @param id the resource id of the desired myview
	 * @return The myview if found or null otherwise.
	 */
	...
	/**
	 * Register the above content myview.
	 *
	 * @param v the above content myview to register
	 * @param params LayoutParams for that myview (unused)
	 */
	...
	/**
	 * Set the activity content to an explicit myview. This myview is placed directly into the activity's myview
	 * hierarchy. It can itself be a complex myview hierarchy. When calling this method, the layout parameters
	 * of the specified myview are ignored. Both the width and the height of the myview are set by default to
	 * MATCH_PARENT. To use your own layout parameters, invoke setContentView(android.myview.View,
	 * android.myview.ViewGroup.LayoutParams) instead.
	 *
	 ...
	 * @param layoutParams Layout parameters for the myview. (unused)
	 */
	...
	/**
	 * Open the SlidingMenu and show the secondary menu myview. Will default to the regular menu
