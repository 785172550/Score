...
public class SlidingPreferenceActivity extends PreferenceActivity implements SlidingActivityBase {
	...
	/* (non-Javadoc)
	 * @see android.app.Activity#setContentView(android.myview.View)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Activity#setContentView(android.myview.View, android.myview.ViewGroup.LayoutParams)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jeremyfeinstein.slidingmenu.lib.app.SlidingActivityBase#setBehindContentView(android.myview.View)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jeremyfeinstein.slidingmenu.lib.app.SlidingActivityBase#setBehindContentView(android.myview.View, android.myview.ViewGroup.LayoutParams)
	 */
	...
	/* (non-Javadoc)
	 * @see android.app.Activity#onKeyUp(int, android.myview.KeyEvent)
	 */
	@Override
