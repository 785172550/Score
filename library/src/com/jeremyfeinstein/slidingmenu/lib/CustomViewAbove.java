...
public class CustomViewAbove extends ViewGroup {
	...
	private void completeScroll() {
		...
		if (needPopulate) {
			// Done with scroll, no longer want to cache myview drawing.
			setScrollingCacheEnabled(false);
	 ...
	 * @param checkV Whether the myview v passed should itself be checked for scrollability (true),
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		// Let the focused myview and/or our descendants get the key first
		return super.dispatchKeyEvent(event) || executeKeyEvent(event);
	}

	/**
	 * You can call this function yourself to have the scroll myview perform
	 * scrolling from a key event, just as if the event had been dispatched to
	 * it by the myview hierarchy.
	 *
