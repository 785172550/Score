 ...
 */
public class SubQues extends LinearLayout {
	...
	public SubQues(Context context,String title,Itemchecked itemchecked,String...answer){
		super(context);
		this.title = title;
		this.answer = answer;
	...
	public void init() {
		...
		mView = mInflater.inflate(R.layout.question2, null);
		...
		radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				itemchecked.checked(SubQues.this,checkedId);
			}
		});
